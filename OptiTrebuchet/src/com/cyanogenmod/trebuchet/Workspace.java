...
public class Workspace extends PagedView
    ...
    protected void snapToPage(int whichPage, int duration) {
        if(!mLoopPages) {
            ...
            if(mCurrentPage == whichPage && mCurrentPage == 0) whichPage = getChildCount() - 1;
            else if(mCurrentPage == whichPage && mCurrentPage == getChildCount() -1) whichPage = 0;
            else whichPage = Math.max(0, Math.min(whichPage, getChildCount() -1 ));
        }
